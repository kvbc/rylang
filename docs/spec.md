...
| &emsp; 1.4. [Literals](#literals)                                                 |   ✔️   |     👇      |       👇       |      👇       | Integer, float, string, character, struct                                  |
...
### 2.2.3. Compile-time expressions {#compile-time-expressions}
...
## 3.2. Function Type {#function-type}
