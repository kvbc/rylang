...
| Chapter                                                           | Syntax | Implemented | Test Coverage | Description                                        |
| ----------------------------------------------------------------- | :----: | :---------: | :-----------: | -------------------------------------------------- |
| 1. [Lexical Analysis](#lexical-analysis)                          |   ✔️   |     N/A     |      N/A      | **Grouping characters into tokens**                |
...
| 3. [Operators](#operators)                                        |  N/A   |     N/A     |      N/A      |
...
| 4. [Expressions](#expressions)                                    |  N/A   |     N/A     |      N/A      |
